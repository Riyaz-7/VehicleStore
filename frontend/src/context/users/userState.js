...
const UserState = (props) => {
  //const host = 'vehiclepro.herokuapp.com'
  ...
  const allusers = async () => {
    const response = await fetch(`${host}/user/allusers`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
  ...
  const addToCart = async (vehicledetails) => {
    const response = await fetch(
      `${host}/cart/addtocart/${vehicledetails._id}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const removeFromCart = async (id) => {
    const response = await fetch(`${host}/cart/removefromcart/${id}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "auth-token": localStorage.getItem("token"),
  ...
  const ordervehicle = async (id) => {
    const response = await fetch(`${host}/order/orderVehicle/${id}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "auth-token": localStorage.getItem("token"),
  ...
  const userorders = async () => {
    const response = await fetch(`${host}/order/viewUserorders`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "auth-token": localStorage.getItem("token"),
  ...
  const allordersfunc = async () => {
    const response = await fetch(`${host}/order/viewallorders`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "auth-token": localStorage.getItem("token"),
